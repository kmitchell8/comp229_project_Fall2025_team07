...
const LibraryProfile = ({ tenantId = null }) => {
    ...
    }, [tenantId, resetLocalStates, setIsEditing]);// Dependency on tenantId is critical

    // Find the specific branch data from the library details
    const branchData = useMemo(() => {
        return libraryDetails?.branches?.find(b => b._id === tenantId) || {};
    }, [libraryDetails, tenantId]);
    ...
    const handleUpdateSubmit = async () => {
        await submitBranchUpdates(tenantId);
    };
    ...
    return (
        <div className={`media ${isSaving ? 'processing-blur' : ''}`}>
            ...
            <input 
                ...
                style={{ display: 'none' }} 
                accept="image/*" 
                onChange={(e) => onCoverSelected(e, tenantId)} 
            />
            ...
            <main className="media-type">
                            ...
                            <div className="detail-entry full-width">
                                ...
                                {isEditing ? (
                                    <input
                                        ...
                                        onChange={(e) => handleInputChange(e, 'branchName', false, tenantId)}
                            ...
                            <div className="detail-entry">
                                ...
                                {isEditing ? (
                                    <input
                                        ...
                                        onChange={(e) => handleInputChange(e, 'email', false, tenantId)}
                                        className="editable-input"
                                    />
                                ) : (
                                ...
                                <div key={field.id} className={`detail-entry ${field.fullWidth ? 'full-width' : ''}`}>
                                    ...
                                    {isEditing ? (
                                        <input
                                            ...
                                            onChange={(e) => handleInputChange(e, field.id, true, tenantId)}
                                            className="editable-input"
                                        />
                                    ) : (
                            ...
                            <div className="detail-entry">
                                ...
                                {isEditing ? (
                                    <select
                                        ...
                                        onChange={(e) => handleInputChange(e, 'Country', true, tenantId)}
                                        className="editable-input"
                                    >
                            ...
                            <div className="detail-entry">
                                ...
                                {isEditing ? (
                                    <select
                                        ...
                                        onChange={(e) => handleInputChange(e, 'province', true, tenantId)}
                                        className="editable-input"
                                    >
                ...
                <footer className="media-full-description debug-footer">
                    ...
                    <div className="text-content">
                        <p><strong>Branch ID:</strong> {tenantId}</p>
